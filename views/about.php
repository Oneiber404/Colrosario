                        ...
                        <div class="navbar-nav mr-auto py-0">
                            ...
                            <div class="nav-item dropdown">
                                ...
                                <div class="dropdown-menu rounded-0 m-0">
                                    <a href="blog.html" class="dropdown-item">Horizonte Institucional</a>
                                    <a href="single.html" class="dropdown-item">Pastoral</a>
                                    <a href="blog.html" class="dropdown-item">Convivencia</a>
                                    <a href="single.html" class="dropdown-item">Política de Calidad</a>
                                    <a href="blog.html" class="dropdown-item">Reseña Histórica</a>
                                </div>
                            </div>
                            <div class="nav-item dropdown">
                                <a href="#" class="nav-link dropdown-toggle" data-toggle="dropdown">Admisiones</a>
                                <div class="dropdown-menu rounded-0 m-0">
                                    <a href="blog.html" class="dropdown-item">Proceso de Admisión</a>
                                    <a href="single.html" class="dropdown-item">Plan de Estudio</a>
                                    <a href="single.html" class="dropdown-item">Tarifas año 2023</a>
                                </div>
                            </div>
                            <div class="nav-item dropdown">
                                <a href="#" class="nav-link dropdown-toggle" data-toggle="dropdown">Comunicaciones</a>
                                <div class="dropdown-menu rounded-0 m-0">
                                    <a href="blog.html" class="dropdown-item">Circulares Padres de Familia</a>
                                    <a href="single.html" class="dropdown-item">Seguro Estudiantil</a>
                                    <a href="blog.html" class="dropdown-item">Reglamento del consejo Estudiantil</a>
                                    <a href="single.html" class="dropdown-item">Seguro Estudiantil</a>
                                </div>
                            </div>
                            <div class="nav-item dropdown">
                                ...
                                <div class="dropdown-menu rounded-0 m-0">
                                    <a href="blog.html" class="dropdown-item">Psicología</a>
                                    <a href="single.html" class="dropdown-item">Enfermería</a>
                                    <a href="blog.html" class="dropdown-item">Capellanía</a>
                                    <a href="single.html" class="dropdown-item">Biblioteca</a>
                                    <a href="single.html" class="dropdown-item">Cafetería</a>
                                    <a href="single.html" class="dropdown-item">Formación Artística y Deportiva</a>
                                </div>
                            </div>
                            <div class="nav-item dropdown">
                                <a href="#" class="nav-link dropdown-toggle" data-toggle="dropdown">Explorar</a>
                                <div class="dropdown-menu rounded-0 m-0">
                                    <a href="blog.html" class="dropdown-item">Egresados 2022</a>
                                    <a href="single.html" class="dropdown-item">Enlaces</a>
                                    <a href="view/galeria.html" class="dropdown-item">Galeria 2022</a>
                                    <a href="blog.html" class="dropdown-item">Lista de Útiles</a>
                                </div>
                            </div>
